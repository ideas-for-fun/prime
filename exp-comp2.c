...
void break_product(__uint128_t product, __uint128_t prime, __uint128_t difference, __uint128_t actual_prime)
{
	int iter = 0;
...
// Print c1compute and c2compute
	...
	break_product(product, c1compute, difference, actual_prime );
